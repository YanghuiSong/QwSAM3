...
try:
    ...
    # Provide a fallback when iopath is not available
    class GPathManager:
...
def build_sam3_image_model(
    ...
    eval_mode=False,  # 评估时使用True，训练时使用False
    checkpoint_path=None,
    load_from_HF=False,  # 修改：默认不从HF加载
    ...
    # 修改：如果 checkpoint_path 为 None 且 load_from_HF 为 False，则使用本地默认路径
